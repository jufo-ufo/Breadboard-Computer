...
\begin{document}
    ...
    Viele Logikoperationen und komplexere konditionale Jumps.
    \begin{center}
        \begin{table*}
    ...
    universelle Ports zum Anschließen von Festplatten, Sensoren, einfachen Tastaturen, LCD-Displays und einer Grafikkarte.
