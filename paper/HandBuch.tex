...
\begin{center}
	\begin{table}[h]
		...
		\begin{tabular}{p{0.045\textwidth} | p{0.1\textwidth} | p{0.12\textwidth} | p{0.40\textwidth} | p{0.22\textwidth}}
			...
			\hline
			 $0\text{x}08$ & Drive & wmn (write multiple normal) & Schreiben einer reihe an 16-Bit werten an 24-Bit Addressen & Iin(Instruktion); Din(startAddresse); n$*$Din(Daten); Dout(bestätigung) \\
			\hline
			...
			\hline
			 $0\text{x}08$ & Drive & wmb (write multiple big) & Schreiben einer reihe an 16-Bit werten an 40-Bit Addressen & Iin(Instruktion); Din(startAddresse); n$*$Din(Daten); Dout(bestätigung) \\
			\hline
			 $0\text{x}08$ &  & & & \\
			\hline
			 $0\text{x}08$ &  & & &
