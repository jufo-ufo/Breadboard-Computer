	...
	\begin{table}[h]
		...
		\begin{tabular}{l | l | l | l}
			...
			\hline
			 ...
			 3 & L     & Ungleichheit ($<$) zweier Werte 			& TEST arg[0] < arg[0]\\
			 4 & OFadd & Integer Overflow bei einer Addition 		& TEST arg[0] + arg[1] > $65535$ \\
			 5 & OFsub & Integer Overflow bei einer Subtraktion 	& TEST arg[0] - arg[1] < $0$ \\
			 6 & OFmul & Integer Overflow bei einer Multiplikation 	& TEST arg[0] * arg[1] > $65535$\\
			 7 & OFdiv & Integer Overflow bei einer Division 		& TEST arg[0] / arg[1] < $0$\\
